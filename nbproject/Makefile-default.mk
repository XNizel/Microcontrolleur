...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/TP2_V2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=Configuration_bits.c Interrupt.c LCD.c user.c main.c CAN.c I2C.c get_clav.c EUSART.c Timer.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Configuration_bits.p1 ${OBJECTDIR}/Interrupt.p1 ${OBJECTDIR}/LCD.p1 ${OBJECTDIR}/user.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/CAN.p1 ${OBJECTDIR}/I2C.p1 ${OBJECTDIR}/get_clav.p1 ${OBJECTDIR}/EUSART.p1 ${OBJECTDIR}/Timer.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/Configuration_bits.p1.d ${OBJECTDIR}/Interrupt.p1.d ${OBJECTDIR}/LCD.p1.d ${OBJECTDIR}/user.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/CAN.p1.d ${OBJECTDIR}/I2C.p1.d ${OBJECTDIR}/get_clav.p1.d ${OBJECTDIR}/EUSART.p1.d ${OBJECTDIR}/Timer.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Configuration_bits.p1 ${OBJECTDIR}/Interrupt.p1 ${OBJECTDIR}/LCD.p1 ${OBJECTDIR}/user.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/CAN.p1 ${OBJECTDIR}/I2C.p1 ${OBJECTDIR}/get_clav.p1 ${OBJECTDIR}/EUSART.p1 ${OBJECTDIR}/Timer.p1

# Source Files
SOURCEFILES=Configuration_bits.c Interrupt.c LCD.c user.c main.c CAN.c I2C.c get_clav.c EUSART.c Timer.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/TP2_V2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/TP2_V2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/TP2_V2.X.${IMAGE_TYPE}.map  -D__DEBUG=1  --debugger=pickit3  -DXPRJ_default=$(CND_CONF)    --double=24 --float=24 --emi=wordwrite --ram=default,20000-1FFFFF --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD)  -odist/${CND_CONF}/${IMAGE_TYPE}/TP2_V2.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/TP2_V2.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/TP2_V2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/TP2_V2.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)    --double=24 --float=24 --emi=wordwrite --ram=default,20000-1FFFFF --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD)  -odist/${CND_CONF}/${IMAGE_TYPE}/TP2_V2.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
